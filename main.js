...
function cardGenerator (cardValues) {
          ...
          if(!card.classList.contains("matched")){
            ...
            //if both are the same , they get a matched class
             if (firstCardValue == secondCardvalue ){
                ...
                if(winCounts == Math.floor(cardValues.length / 2)){
 ...
 //if player was inmiddle of the game overlay does not showen again and startgame is callen 
 //overlay has a event listener that start the game

 
 //this function job is initializing values ,
